...
\begin{lemma}[Forest Structure by Root Assignment]
\label{lem:forest-structure}
...
\begin{proof}
By exhaustive enumeration of all 3-rooted spanning forests on $K_6$.
\end{proof}
...
\begin{lemma}[Signed Factorization]
