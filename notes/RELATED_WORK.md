...
3.  **Factorization via Geometry:** We aim to show that the *facets* of this specific polytope naturally encode the physical factorization channels of gravity, providing a geometric proof of unitarity in this sector.
